$(document).ready(function() {
    ...
    $('#pass2').keyup(function() {
        ...
        if($('#pass1').val() != '' && $('#pass2').val() != $('#pass1').val()) {
            console.log('if');
            $('#pass2-w').html('Password doesn\'t match  <i class="fas fa-exclamation-triangle"></i>')
            $('#pass2-w').show();
        }else{
            $('#pass2-w').hide();
        }
    ...
    $("#userTypeSelected").change(function() {
    ...
    $("#userTypeSelected").trigger("change");

    $("#brokerTypeSelected").change(function() {
        if ($(this).val() == "yes") {
          $('.broker-yes').show();
        } else {
          $('.broker-yes').hide();
    ...
    $("#brokerTypeSelected").trigger("change");
